...
namespace webnet {
    ...
    class URLRequest {
      public:
        ...
        void* complete_callback_ = nullptr;
    };
    class URLResponse {
      public:
        std::string client_msg_id_ = "";
    ...
    extern void OnProgressChanged(const std::string& _id, size_t _completed_length, size_t _total_length, void* callback);
    extern void OnDownloadCompleted(const std::string& _id, const URLDownloadResponse& _response, void* callback);
