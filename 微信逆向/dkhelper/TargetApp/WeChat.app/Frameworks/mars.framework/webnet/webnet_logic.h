...
namespace webnet {
    ...
    class Callback
    {
      public:
        virtual ~Callback(){}
        virtual void OnProgressChanged(const std::string& _id, size_t _completed_length, size_t _total_length, void* callback){}
        virtual void OnDownloadCompleted(const std::string& _id, const URLDownloadResponse& _response, void* callback){}
    };
