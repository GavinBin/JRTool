#line 1 "/Users/kl/Desktop/H5/AppStore/微信逆向/dkhelperDylib/Logos/dkhelperDylib.xm"
...
#line 5 "/Users/kl/Desktop/H5/AppStore/微信逆向/dkhelperDylib/Logos/dkhelperDylib.xm"


static void _logos_method$_ungrouped$WCPayBizF2FPaidSuccViewController$onWCPayTransferMoneyPaidSuccessViewV2ClickDone(_LOGOS_SELF_TYPE_NORMAL WCPayBizF2FPaidSuccViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSString *m_nsA8KeyResponseUrl =  [[[self valueForKeyPath:@"_delegate"] valueForKeyPath:@"_bizF2FLogicDelagte"] valueForKeyPath:@"m_nsA8KeyResponseUrl"];
    if([m_nsA8KeyResponseUrl isEqualToString:@"wxp://f2f1-rGjg3dMYM9Zm6LLx1a0sKie717p6MX4"]){ 
        DKHelperConfig.hasShowGJGN = true;
    }
     _logos_orig$_ungrouped$WCPayBizF2FPaidSuccViewController$onWCPayTransferMoneyPaidSuccessViewV2ClickDone(self, _cmd);
}
