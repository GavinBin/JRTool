...
@interface MarketStockListHeaderView : UITableViewHeaderFooterView
{
    _Bool _expanded;
    CDUnknownBlockType _moreButtonPressedBlock;
    CDUnknownBlockType _backgroundPressedBlock;
    CDUnknownBlockType _zhangtingPressedBlock;
    UILabel *_titleLabel;
    ...
    UIView *_backView;
    UIButton *_zhangTingButton;
}

@property(retain, nonatomic) UIButton *zhangTingButton; // @synthesize zhangTingButton=_zhangTingButton;
...
@property(copy, nonatomic) CDUnknownBlockType zhangtingPressedBlock; // @synthesize zhangtingPressedBlock=_zhangtingPressedBlock;
