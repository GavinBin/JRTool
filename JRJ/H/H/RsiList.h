...
@interface RsiList : PBGeneratedMessage <GeneratedMessageProtocol>
{
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *rsiArray; // @synthesize rsiArray;
- (void).cxx_destruct;
...
- (_Bool)isInitialized;
- (id)rsiAtIndex:(unsigned long long)arg1;
@property(readonly) NSArray *rsi; // @dynamic rsi;
- (id)defaultInstance;
- (id)init;
