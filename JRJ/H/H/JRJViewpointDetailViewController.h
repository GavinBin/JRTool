...
@class JRJCommentHeaderView, JRJInputAccessoryView, JRJRCLabelProxy, JRJViewpointInput, NSLayoutConstraint, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIView, UIWebView, WebViewJumpSerialization;

@interface JRJViewpointDetailViewController : JRJCommentTableViewController <UIWebViewDelegate, UIGestureRecognizerDelegate>
{
    _Bool _largeFont;
    _Bool _hasNoData;
...
- (void)refreshRewardArea;
- (void)openRewardViewControllerWithURL:(id)arg1;
- (void)followAdviser:(id)arg1;
- (void)openReportViewControllerWithURL:(id)arg1;
...
- (void)viewDidLoad;
- (id)initWithViewpointId:(id)arg1;
