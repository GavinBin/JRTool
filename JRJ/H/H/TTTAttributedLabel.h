...
@interface TTTAttributedLabel : UILabel <TTTAttributedLabelDelegate, TTTAttributedLabel, UIGestureRecognizerDelegate>
{
...
- (void)addStocksWithDicArr:(id)arg1 title:(id)arg2 needCount:(long long)arg3 keyPoint:(id)arg4;
- (void)addStocksWithArray:(id)arg1 title:(id)arg2 needCount:(long long)arg3 keyPoint:(id)arg4;
- (void)addStocksWithString:(id)arg1 title:(id)arg2 needCount:(long long)arg3 keyPoint:(id)arg4;
- (void)addStocksWithArray:(id)arg1 needCount:(long long)arg2 keyPoint:(id)arg3;
- (void)addStocksWithString:(id)arg1 needCount:(long long)arg2 keyPoint:(id)arg3;
