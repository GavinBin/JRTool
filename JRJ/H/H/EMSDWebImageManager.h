...
@class EMSDImageCache, EMSDWebImageDownloader, NSMutableArray;
@protocol EMSDWebImageManagerDelegate;

@interface EMSDWebImageManager : NSObject
{
    id <EMSDWebImageManagerDelegate> _delegate;
    EMSDImageCache *_imageCache;
    EMSDWebImageDownloader *_imageDownloader;
...
@property(retain, nonatomic) EMSDWebImageDownloader *imageDownloader; // @synthesize imageDownloader=_imageDownloader;
@property(retain, nonatomic) EMSDImageCache *imageCache; // @synthesize imageCache=_imageCache;
@property(nonatomic) __weak id <EMSDWebImageManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (_Bool)isRunning;
- (void)cancelAll;
