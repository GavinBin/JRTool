...
@interface SecuritySummaryList : PBGeneratedMessage <GeneratedMessageProtocol>
{
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *summaryArray; // @synthesize summaryArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *summary; // @dynamic summary;
- (id)defaultInstance;
- (id)init;
