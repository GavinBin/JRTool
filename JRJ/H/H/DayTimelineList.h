...
@interface DayTimelineList : PBGeneratedMessage <GeneratedMessageProtocol>
{
    NSMutableArray *dayTimeLineArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *dayTimeLineArray; // @synthesize dayTimeLineArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *dayTimeLine; // @dynamic dayTimeLine;
- (id)defaultInstance;
- (id)init;
