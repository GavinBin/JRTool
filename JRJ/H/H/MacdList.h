...
@interface MacdList : PBGeneratedMessage <GeneratedMessageProtocol>
{
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *macdArray; // @synthesize macdArray;
- (void).cxx_destruct;
...
- (_Bool)isInitialized;
- (id)macdAtIndex:(unsigned long long)arg1;
@property(readonly) NSArray *macd; // @dynamic macd;
- (id)defaultInstance;
- (id)init;
