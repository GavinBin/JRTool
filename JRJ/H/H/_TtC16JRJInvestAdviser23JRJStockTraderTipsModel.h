...
@interface _TtC16JRJInvestAdviser23JRJStockTraderTipsModel : _TtC16JRJInvestAdviser12JRJBaseModel
{
    // Error parsing type: , name: market
    // Error parsing type: , name: signalType
    // Error parsing type: , name: signalTypeDesc
...
@property(nonatomic, copy) NSString *signalTypeDesc;
