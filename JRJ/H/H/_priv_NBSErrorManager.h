...
@interface _priv_NBSErrorManager : NSLock
{
    ...
    _Bool busy;
    int busy_length;
    NSObject<OS_dispatch_queue> *nbs_queue;
...
- (void)logErrorWithError:(id)arg1 urlString:(id)arg2 stackTrace:(id)arg3 userActionID:(id)arg4;
- (void)logErrorWithHTTPError:(id)arg1 Response:(id)arg2 ResponseData:(id)arg3 withIP:(id)arg4 cdnAssosiateInfo:(id)arg5 libClass:(long long)arg6 appPhase:(long long)arg7 userActionID:(id)arg8;
- (void)logErrorWithError:(id)arg1 Request:(id)arg2 withIP:(id)arg3 cdnAssosiateInfo:(id)arg4 libClass:(long long)arg5 appPhase:(long long)arg6 userActionID:(id)arg7;
...
- (id)getKeyFromURI:(id)arg1 urlParams:(id)arg2 statusCode:(int)arg3 httpMethod:(id)arg4 libClass:(long long)arg5 appPhase:(long long)arg6 userActionId:(id)arg7;
- (void)dealloc;
- (id)init;
