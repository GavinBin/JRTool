...
@interface JRJZTradeDangousModeListViewController : JRJListTableViewController
{
...
+ (void)p_JRJZTradeDangousModeListViewController;
...
- (void)p_handleResponseWithDic:(id)arg1;
