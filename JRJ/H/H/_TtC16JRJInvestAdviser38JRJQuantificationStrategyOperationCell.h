...
@class NSLayoutConstraint, UIButton, UILabel, _TtC16JRJInvestAdviser25JRJStrategyOperationModel;

@interface _TtC16JRJInvestAdviser38JRJQuantificationStrategyOperationCell : _TtC16JRJInvestAdviser10ZKBaseCell
{
    ...
    // Error parsing type: , name: orderBtn
...
@property(nonatomic) __weak UIButton *orderBtn; // @synthesize orderBtn;
