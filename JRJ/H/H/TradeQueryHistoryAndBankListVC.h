...
@class TradeQueryDateHeaderView, TradeQueryHandler;

@interface TradeQueryHistoryAndBankListVC : KKTableViewController
{
    int _type;
    TradeQueryHandler *_tradeQueryHandler;
    TradeQueryDateHeaderView *_headerView;
}

@property(retain, nonatomic) TradeQueryDateHeaderView *headerView; // @synthesize headerView=_headerView;
