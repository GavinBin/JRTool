...
@class NSString, StockInfoMainFooterView;

@interface StockIntelligenceListController : JRJListTableViewController <YZStockInfoCenterCellDelegate>
{
...
- (void)requestIntelligenceListIsLoadMore:(_Bool)arg1;
