...
@interface TradeDetailList : PBGeneratedMessage <GeneratedMessageProtocol>
{
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *tradeDetailArray; // @synthesize tradeDetailArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *tradeDetail; // @dynamic tradeDetail;
- (id)defaultInstance;
- (id)init;
