...
@interface SecuritySyncList : PBGeneratedMessage <GeneratedMessageProtocol>
{
    NSMutableArray *securitySyncItemArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
+ (id)listWithStockList:(id)arg1;
+ (id)listWithMarkets;
@property(retain) NSMutableArray *securitySyncItemArray; // @synthesize securitySyncItemArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *securitySyncItem; // @dynamic securitySyncItem;
- (id)defaultInstance;
- (id)init;
