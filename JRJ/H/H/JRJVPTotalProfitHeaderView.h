...
@interface JRJVPTotalProfitHeaderView : UIView
{
...
@property(nonatomic) __weak UIImageView *imv_type_arrow; // @synthesize imv_type_arrow=_imv_type_arrow;
@property(nonatomic) __weak UIImageView *imv_price_arrow; // @synthesize imv_price_arrow=_imv_price_arrow;
@property(nonatomic) __weak UIImageView *imv_group_arrow; // @synthesize imv_group_arrow=_imv_group_arrow;
@property(nonatomic) __weak UILabel *lblUpDownRate; // @synthesize lblUpDownRate=_lblUpDownRate;
@property(nonatomic) __weak UILabel *lblClosePrice; // @synthesize lblClosePrice=_lblClosePrice;
@property(nonatomic) __weak UILabel *lblStockName; // @synthesize lblStockName=_lblStockName;
- (void).cxx_destruct;
- (void)tap_third_action:(id)arg1;
- (void)tap_second_action:(id)arg1;
- (void)tap_first_action:(id)arg1;
- (void)configDefaultOrderType:(long long)arg1;
- (void)reset;
