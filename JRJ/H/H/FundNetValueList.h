...
@interface FundNetValueList : PBGeneratedMessage <GeneratedMessageProtocol>
{
    NSMutableArray *fundNetValueArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *fundNetValueArray; // @synthesize fundNetValueArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *fundNetValue; // @dynamic fundNetValue;
- (id)defaultInstance;
- (id)init;
