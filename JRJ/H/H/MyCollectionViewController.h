...
@class FSSegmentTitleView, MyCollectionNewsViewController, NSArray, NSString, VTMagicController;

@interface MyCollectionViewController : JRJBaseViewController <VTMagicViewDataSource, VTMagicViewDelegate, FSSegmentTitleViewDelegate>
{
    unsigned long long _selectType;
    NSArray *_menuList;
    FSSegmentTitleView *_segmentTitleView;
    MyCollectionNewsViewController *_collectionNewsVC;
...
@property(retain, nonatomic) MyCollectionNewsViewController *collectionNewsVC; // @synthesize collectionNewsVC=_collectionNewsVC;
