...
@class JRJOrientationAdditionHeaderView, NSDictionary, NSMutableArray, NSMutableString, NSString;

@interface JRJOrientationAdditionController : JRJListTableViewController <JRJOrientationAdditionFillterViewDelegate>
{
    int _progressFlag;
    int _ratioFlag;
    ...
    JRJOrientationAdditionHeaderView *_headerView;
}

@property(retain, nonatomic) JRJOrientationAdditionHeaderView *headerView; // @synthesize headerView=_headerView;
