...
@interface KdjList : PBGeneratedMessage <GeneratedMessageProtocol>
{
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *kdjArray; // @synthesize kdjArray;
- (void).cxx_destruct;
...
- (_Bool)isInitialized;
- (id)kdjAtIndex:(unsigned long long)arg1;
@property(readonly) NSArray *kdj; // @dynamic kdj;
- (id)defaultInstance;
- (id)init;
