...
@class JRJMyAnswerViewController, NSString;

@interface JRJMyAnswerPageViewController : WMPageController <WMPageControllerDelegate>
{
    JRJMyAnswerViewController *_answerVC;
    JRJMyAnswerViewController *_noAnswerVC;
}

@property(retain, nonatomic) JRJMyAnswerViewController *noAnswerVC; // @synthesize noAnswerVC=_noAnswerVC;
