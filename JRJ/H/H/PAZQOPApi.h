...
@interface PAZQOPApi : NSObject
{
    ...
    PAZQOPVideoViewController *_videoController;
    NSTimer *_backTimer;
    NSString *_allowNext;
...
@property(retain, nonatomic) NSString *allowNext; // @synthesize allowNext=_allowNext;
...
@property(retain, nonatomic) PAZQOPVideoViewController *videoController; // @synthesize videoController=_videoController;
...
- (void).cxx_destruct;
- (void)callbackForBlockWithContent:(id)arg1;
...
- (id)GetSDKVersion;
- (void)getSystemAdvMsgForNative;
- (void)startVideo;
- (void)configVideo:(id)arg1 channelId:(id)arg2 callback:(CDUnknownBlockType)arg3;
- (void)checkMicrophoneAndCameraAvailableWithSuperVC:(id)arg1 callback:(CDUnknownBlockType)arg2;
- (void)enterVideoViewController:(id)arg1 callback:(CDUnknownBlockType)arg2;
