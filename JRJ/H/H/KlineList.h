...
@interface KlineList : PBGeneratedMessage <GeneratedMessageProtocol>
{
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *klineArray; // @synthesize klineArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *kline; // @dynamic kline;
- (id)defaultInstance;
- (id)init;
