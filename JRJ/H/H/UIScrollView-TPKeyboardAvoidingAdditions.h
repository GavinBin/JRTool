...
- (void)TPKeyboardAvoiding_findTextFieldAfterTextField:(id)arg1 beneathView:(id)arg2 minY:(double *)arg3 foundView:(id *)arg4;
...
@property(nonatomic) double keyboardMargin;
@end
