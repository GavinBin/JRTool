...
@class NSMutableDictionary, NSString, PAZQOPCamera, PAZQOPMainViewController, UIWebView;
...
@interface PAZQOPStockNative : NSObject <UIAlertViewDelegate, CustomAlertViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    ...
    NSString *closeSchema;
    _Bool isopen;
    _Bool _nowInH5Page;
    UIWebView *_currentWebView;
    NSString *_function_callback;
    PAZQOPMainViewController *_currentViewController;
    NSString *_transparentStr;
}

+ (id)sharedUtil;
@property(nonatomic) _Bool nowInH5Page; // @synthesize nowInH5Page=_nowInH5Page;
@property(retain, nonatomic) NSString *transparentStr; // @synthesize transparentStr=_transparentStr;
@property(nonatomic) __weak PAZQOPMainViewController *currentViewController; // @synthesize currentViewController=_currentViewController;
...
- (void)renderThemeColorPlugin:(id)arg1 viewController:(id)arg2;
- (void)openTheDeskAppPlugin:(id)arg1 viewController:(id)arg2;
- (void)copyToClipboardPlugin:(id)arg1 viewController:(id)arg2;
...
- (void)callbackH5WithMethod:(id)arg1 parameters:(id)arg2;
