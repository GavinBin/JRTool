...
@class EMSDWebImageManager, NSArray;
@protocol EMSDWebImagePrefetcherDelegate;

@interface EMSDWebImagePrefetcher : NSObject
{
    EMSDWebImageManager *_manager;
    unsigned long long _options;
    id <EMSDWebImagePrefetcherDelegate> _delegate;
...
@property(nonatomic) __weak id <EMSDWebImagePrefetcherDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) unsigned long long options; // @synthesize options=_options;
@property(retain, nonatomic) EMSDWebImageManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
